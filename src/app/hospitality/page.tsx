          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                ...
                <span className="text-accent font-sans text-sm tracking-[0.2em] uppercase">TMT Hospitality</span>
              </motion.div>
              <motion.h1 variants={fadeUp} className="text-4xl md:text-5xl lg:text-7xl font-serif text-primary leading-[1.1] mb-8">
                Curating <br />
                <span className="italic text-slate-400">Premium Experiences</span>
              </motion.h1>
              <motion.p variants={fadeUp} className="text-xl text-slate-600 leading-relaxed font-light mb-10 max-w-lg">
                Defining luxury and comfort through world-class hospitality investments and management services.
              </motion.p>
            ...
            >
              ...
              <div className="absolute inset-0 bg-white border border-slate-100 rounded-2xl rotate-2 overflow-hidden shadow-2xl flex items-center justify-center">
                 <div className="text-slate-300 text-center p-8">
                  ...
                  <p className="font-serif italic text-xl">Luxury Resorts</p>
                 </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Hotel, title: "Hotel Management", desc: "Operating high-end boutique and commercial hotels with a focus on guest satisfaction." },
              { icon: Utensils, title: "Culinary Services", desc: "Fine dining and professional catering solutions scaled for events of any size." },
              { icon: Sparkles, title: "Guest Experience", desc: "Designing bespoke leisure and tourism experiences for maximum relaxation." }
            ].map((service, i) => (
              <motion.div
                key={i}
                initial="hidden"
