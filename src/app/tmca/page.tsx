...
import { ArrowRight, BookOpen, Presentation, Award, Briefcase } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                ...
                <span className="text-accent font-sans text-xs tracking-[0.3em] uppercase font-bold">The Management & Creative Agency</span>
              </motion.div>
              <motion.h1 variants={fadeUp} className="text-4xl md:text-5xl lg:text-7xl font-serif text-primary leading-[1.1] mb-8">
                Corporate <br />
                <span className="italic text-accent font-light">Academy</span>
              </motion.h1>
              <motion.p variants={fadeUp} className="text-xl text-slate-500 leading-relaxed font-sans font-light mb-10 max-w-lg">
                Fostering professional excellence through specialized training, executive coaching, and leadership development programs tailored for the African landscape.
              </motion.p>
            ...
            >
              ...
              <div className="relative w-full h-full overflow-hidden rounded-sm shadow-2xl">
                <Image 
                  ...
                  alt="African Corporate Leadership Training"
                  fill
              ...
              <motion.div 
                ...
                className="absolute -bottom-10 -right-6 bg-white p-8 shadow-xl border border-accent/10 max-w-xs hidden md:block"
              >
                <Presentation className="w-8 h-8 text-accent mb-4" />
                <p className="font-serif italic text-lg text-primary">"Empowering the next generation of African visionaries."</p>
              </motion.div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-32 bg-background relative border-t border-accent/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-6xl font-serif text-primary mb-8">Mastery & <span className="italic font-light text-accent">Leadership</span></h2>
            <p className="text-slate-500 font-sans font-light leading-relaxed">
              Our programs are designed to bridge the gap between potential and performance, creating leaders who drive sustainable impact.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Briefcase, title: "Executive Coaching", desc: "One-on-one mentorship designed to elevate C-suite performance and strategic decision-making." },
              { icon: BookOpen, title: "Corporate Workshops", desc: "Tailored team-building and skill-acquisition seminars for growing enterprises and established firms." },
              { icon: Award, title: "Certification Programs", desc: "Industry-recognized qualifications that ensure organizational excellence and professional mastery." }
            ].map((service, i) => (
              <motion.div
                key={i}
                initial="hidden"
