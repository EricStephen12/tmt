          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                ...
                <span className="text-accent font-sans text-sm tracking-[0.2em] uppercase">TMCA</span>
              </motion.div>
              <motion.h1 variants={fadeUp} className="text-5xl lg:text-7xl font-serif text-primary leading-[1.1] mb-8">
                Corporate <br />
                <span className="italic text-slate-400">Academy</span>
              </motion.h1>
              <motion.p variants={fadeUp} className="text-xl text-slate-600 leading-relaxed font-light mb-10 max-w-lg">
                Fostering professional excellence through specialized training, executive coaching, and leadership development programs.
              </motion.p>
            ...
            >
              ...
              <div className="absolute inset-0 bg-white border border-slate-100 rounded-2xl rotate-2 overflow-hidden shadow-2xl flex items-center justify-center">
                 <div className="text-slate-300 text-center p-8">
                  ...
                  <p className="font-serif italic text-xl">Leadership & Mastery</p>
                 </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Briefcase, title: "Executive Coaching", desc: "One-on-one mentorship designed to elevate C-suite performance and strategy." },
              { icon: BookOpen, title: "Corporate Workshops", desc: "Tailored team-building and skill-acquisition seminars for growing enterprises." },
              { icon: Award, title: "Certification Programs", desc: "Industry-recognized qualifications that ensure organizational compliance and expertise." }
            ].map((service, i) => (
              <motion.div
                key={i}
                initial="hidden"
