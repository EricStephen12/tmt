...
export default function SignInPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative selection:bg-accent selection:text-white">
      ...
      <div className="relative z-10 w-full max-w-md p-6">
        ...
        <SignIn 
          appearance={{
            elements: {
              card: "shadow-2xl border border-primary/5 rounded-none rounded-br-[50px] rounded-tl-[50px]",
