          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <motion.p variants={fadeUp} className="text-xl text-slate-600 leading-relaxed font-light mb-10 max-w-lg">
                Delivering world-class educational structures focused on holistic development, critical thinking, and character building.
              </motion.p>
            ...
            >
              ...
              <div className="absolute inset-0 bg-white border border-slate-100 rounded-2xl rotate-2 overflow-hidden shadow-2xl flex items-center justify-center">
                 <div className="text-slate-300 text-center p-8">
                  ...
                  <p className="font-serif italic text-xl">Educational Excellence</p>
                 </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: GraduationCap, title: "Modern Curriculum", desc: "Integrating global academic standards with local context for holistic learning." },
              { icon: Users, title: "Student Development", desc: "Fostering leadership, emotional intelligence, and collaborative skills." },
              { icon: BookOpen, title: "Infrastructure", desc: "State-of-the-art facilities that inspire creativity and active participation." }
            ].map((service, i) => (
              <motion.div
                key={i}
                initial="hidden"
